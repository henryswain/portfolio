        ...
        <>
            <div className="flex gap-8 flex-col relative justify-between items-center bg-gradient pb-8">
                ...
                <div className="bg-teal-950 rounded-lg w-85 md:w-180">
                    ...
                    <p className="pb-4 w-full text-wrap text-white px-4">
                        For my first slogan, "thoughts and prayers won't fix the housing inequality crisis", I wanted to use imagery that conveyed praying at a church, but also the crisis of housing inequality. For the thoughts and prayers portion, I looked up prayers and episcopal churches on wikimedia commons. I chose one of the few relatively short horizontal images of a church because I wanted the image to span the entire width of approximately the top third of the poster.
                    </p>
                    <p className="pb-4 w-full text-wrap text-white px-4">
                        For the housing inequality crisis portion, I wanted to convey two extreme ends of housing inequality - a beach house to represent luxury living and a homeless person sleeping on a bench to represent the extreme poverty end of things. I also found these images on wikimedia commons. To further represent this inequality as a crisis, I placed the beach house and the homeless person at uncomfortable opposing steep angles to give the poster a chaotic appearance.
                    </p>
                    <p className="pb-4 w-full text-wrap text-white px-4">
                    ...
                    <p className="pb-4 w-full text-wrap text-white px-4">
                        For my second slogan, "No home, No safety, No security", I wanted to convey general discomfort through negative imagery.
                    </p>
                    <p className="pb-4 w-full text-wrap text-white px-4">
                    ...
                    <p className="pb-4 w-full text-wrap text-white px-4">
                        For this rough draft, I really wanted to convey an eerie and uncomfortable vibe, so I put the background wildfire through a black and white gradient, and the tent, padlock, and keys through a dark green gradient mask.
                    </p>
                    <p className="pb-4 w-full text-wrap text-white px-4">
                    ...
                    <p className="pb-4 w-full text-wrap text-white px-4">
                        During the peer critique session, it became clear that my first rough was more visually compelling, but I was advised to add a gradient on the right to provide a better transition between the two different sections.
                    ...
                    <p className="pb-4 w-full text-wrap text-white px-4">
                        I agreed with all of the suggestions so I implemented them into my final poster.
