...
export default function page() {
    return (
        <>
            ...
            <div className="flex gap-4 flex-col relative justify-between items-center bg-gradient-ambiguous-logo sm:bg-gradient-ambiguous-logo-sm md:bg-gradient-ambiguous-logo-md">
                <NavBar/>
                    <div className="bg-teal-950 absolute left-1/2 top-1/100 rounded-lg -translate-x-1/2 w-85 md:w-180">
