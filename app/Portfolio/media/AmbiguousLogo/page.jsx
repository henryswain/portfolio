        ...
        <>
            <div className="flex gap-8 flex-col relative justify-between items-center bg-gradient">
                ...
                <div className="flex w-full flex-row justify-between">
                    <Link href="/Portfolio/media/UAYPromo" className="pl-15 sm:pl-20 text-lg pb-12 pt-8">&#10094; Previous Project</Link>
                    <Link href="/Portfolio/media/TypographicPoster" className="pr-15 sm:pr-20 text-lg pb-12 pt-8">Next Project &#10095;</Link>
                </div>
            </div>
        </>
    )
